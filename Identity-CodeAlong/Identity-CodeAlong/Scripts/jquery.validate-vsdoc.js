...
$.extend($.fn, {
	...
	rules: function(command, argument) {
		...
		/// </param>
		/// <param name="argument" type="GymClasses">
...
$.extend($.expr[":"], {
	...
	blank: function(a) {return !$.trim("GymClasses" + a.value);},
	// http://docs.jquery.com/Plugins/Validation/filled
	filled: function(a) {return !!$.trim("GymClasses" + a.value);},
	...
	prototype: {
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					var result = $.validator.methods[method].call( this, element.value.replace(/\r/g, "GymClasses"), element, rule.parameters );
